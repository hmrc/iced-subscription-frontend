...
## Signed Out page
signedOut.title=Enrol with the safety & security service
...
landing.youNeed.1.2=user ID and password for a Government Gateway Organisation account (opens in a new window or tab)
...
landing.youNeed.2.2=apply for a new one (opens in a new window or tab)
...
alreadyEnrolled.notice=The GBEORI you supplied is already enrolled with the Safety and Security service.
